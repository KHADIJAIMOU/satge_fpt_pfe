...
--
-- Hôte : 127.0.0.1
-- Généré le : jeu. 13 avr. 2023 à 15:00
...
(5, '2023_04_13_114421_create_rapport_table', 1),
(6, '2023_04_13_123705_create_admins_table', 1);
...
CREATE TABLE `rapport` (
  ...
  `absenceFirstCollege` int(11) DEFAULT NULL,
  `totalFirstCollege` int(11) DEFAULT NULL,
  `absenceSecondCollege` int(11) DEFAULT NULL,
  `totalSecondCollege` int(11) DEFAULT NULL,
  `absenceThirdCollege` int(11) DEFAULT NULL,
  `totalThirdCollege` int(11) DEFAULT NULL,
  `absenceFirstLycee` int(11) DEFAULT NULL,
  `totalFirstLycee` int(11) DEFAULT NULL,
  `absenceSecondLycee` int(11) DEFAULT NULL,
  `totalSecondLycee` int(11) DEFAULT NULL,
  `absenceThirdLycee` int(11) DEFAULT NULL,
  `totalThirdLycee` int(11) DEFAULT NULL,
  ...
  `renionEffectuerConseilAdministratif` tinyint(1) DEFAULT NULL,
  `renionEffectuerConseilsDepartementaux` tinyint(1) DEFAULT NULL,
  `renionEffectuerConseilsPedagogiqueTa3limi` tinyint(1) DEFAULT NULL,
  `renionEffectuerConseilsPedagogiqueTrbaoui` tinyint(1) DEFAULT NULL,
  `renionEffectuerConseilDeGestion` tinyint(1) DEFAULT NULL,
  `renionEffectuerAutreRenion` tinyint(1) DEFAULT NULL,
  `renionEffectuerRien` tinyint(1) DEFAULT NULL,
  `activiteEffectuerIntégrée` int(11) DEFAULT NULL,
  `activiteEffectuerParallel` int(11) DEFAULT NULL,
  `activiteEffectuerRien` int(11) DEFAULT NULL,
  ...
  `classInterieur` tinyint(1) DEFAULT NULL,
...
CREATE TABLE `users` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `CD_ETAB` varchar(255) NOT NULL,
  `NOM_ETABL` varchar(255) NOT NULL,
  `NOM_ETABA` varchar(255) NOT NULL,
  `la_com` varchar(255) NOT NULL,
  `ll_com` varchar(255) NOT NULL,
  `typeEtab` varchar(255) NOT NULL,
  `LL_CYCLE` varchar(255) NOT NULL,
  `LA_CYCLE` varchar(255) NOT NULL,
  `NetabFr` varchar(255) NOT NULL,
  `CD_GIPE` varchar(255) NOT NULL,
  `password` varchar(255) NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `users` (`id`, `CD_ETAB`, `NOM_ETABL`, `NOM_ETABA`, `la_com`, `ll_com`, `typeEtab`, `LL_CYCLE`, `LA_CYCLE`, `NetabFr`, `CD_GIPE`, `password`, `created_at`, `updated_at`) VALUES
(1, '16698Z', 'ECOLE LALLA MERIEME', 'م. للا مريم', 'تزنيت (البلدية)', 'Tiznit (Mun.)', 'Public', 'PRIMAIRE', 'الابتدائي', 'Ecole Autonome', '73700P01', 'password', NULL, NULL),
(2, '16699A', 'ECOLE 18 NOVEMBRE', 'م. 18 نونبر', 'تزنيت (البلدية)', 'Tiznit (Mun.)', 'Public', 'PRIMAIRE', 'الابتدائي', 'Ecole Autonome', '73700P02', 'password', NULL, NULL),
(3, '16700B', 'ECOLE BIR ANZARANE', 'م. بئر انزران', 'تزنيت (البلدية)', 'Tiznit (Mun.)', 'Public', 'PRIMAIRE', 'الابتدائي', 'Ecole Autonome', '73700P03', 'password', NULL, NULL),
(4, '16701C', 'LYCEE COLLEGIAL IBN ROCHD', 'الثانوية الاعدادية ابن رشد', 'تزنيت (البلدية)', 'Tiznit (Mun.)', 'Public', 'SECONDAIRE-COLLEGIAL', 'الثانوي الاعدادي', 'Collège Enseignement Général', '73700P04', 'password', NULL, NULL),
(5, '16702D', 'ECOLE HASSAN I', 'م. الحسن الاول', 'تزنيت (البلدية)', 'Tiznit (Mun.)', 'Public', 'PRIMAIRE', 'الابتدائي', 'Ecole Autonome', '73700P05', 'password', NULL, NULL),
...
(8, '16706H', 'ECOLE AL WAFA', 'م. الوفاء', 'تزنيت (البلدية)', 'Tiznit (Mun.)', 'Public', 'PRIMAIRE', 'الابتدائي', 'Ecole Autonome', '73700P12', 'password', NULL, NULL),
...
(20, '16871M', 'EC ELHOUDAYGUI CENTRE AFELLA IGHIR', 'م.ج الحضيكي مركز افلا اغير', 'أفلا  اغير', 'Afella Ighir', 'Public', 'PRIMAIRE', 'الابتدائي', 'Ecole communale', '73505P01', 'password', NULL, NULL),
(21, '16873P', 'SS SAADIYINE UNITE AIT BOUNOUH', 'م.م السعديين فرعية ايت بنوح', 'أفلا  اغير', 'Afella Ighir', 'Public', 'PRIMAIRE', 'الابتدائي', 'Annexe Ecole Autonome', '', 'password', NULL, NULL),
(22, '16877U', 'SS SAADIYINE UNITE TAGMOUT', 'م.م السعديين فرعية تكموت', 'أفلا  اغير', 'Afella Ighir', 'Public', 'PRIMAIRE', 'الابتدائي', 'Satellite', '', 'password', NULL, NULL),
(23, '16878V', 'SS SAADIYINE UNITE AOUKLID', 'م.م السعديين فرعية اوكليض', 'أفلا  اغير', 'Afella Ighir', 'Public', 'PRIMAIRE', 'الابتدائي', 'Satellite', '', 'password', NULL, NULL),
(24, '16879W', 'SS SAADIYINE CENTRE TIMAGICHT', 'م.م السعديين مركزية تيمكيشت', 'أفلا  اغير', 'Afella Ighir', 'Public', 'PRIMAIRE', 'الابتدائي', 'Secteur Scolaire Centre', '', 'password', NULL, NULL),
...
(26, '16888F', 'SS ALMOKHTAR ASSOUSSI CENTRE AIT OUAFQA', 'م.م المختار السوسي مركزية ايت وافقا', 'أيت وافقا', 'Ait Ouafqa', 'Public', 'PRIMAIRE', 'الابتدائي', 'Secteur Scolaire Centre', '73509P01', 'password', NULL, NULL),
(27, '16889G', 'SS BAKAR HOUCINE BEN HAISSON UNITE AGNI DIANE', 'م.م بكار حسين بن حيسون فرعية اكني اديان', 'أيت وافقا', 'Ait Ouafqa', 'Public', 'PRIMAIRE', 'الابتدائي', 'Satellite', '73460P21', 'password', NULL, NULL),
(28, '16890H', 'SS ALMOKHTAR ASSOUSSI UNITE TAFOUGAGHT', 'م.م المختار السوسي فرعية تافكاغت', 'أيت وافقا', 'Ait Ouafqa', 'Public', 'PRIMAIRE', 'الابتدائي', 'Satellite', '', 'password', NULL, NULL),
(29, '16891J', 'SS ALABDARI UNITE TIZI NTAWIT', 'م.م العبدري فرعية تزي نتاويت', 'أيت وافقا', 'Ait Ouafqa', 'Public', 'PRIMAIRE', 'الابتدائي', 'Satellite', '73509P02', 'password', NULL, NULL),
(30, '16892K', 'SS BAKAR HOUCINE BEN HAISSON UNITE SLATE', 'م.م بكار حسين بن حيسون فرعية سلات', 'أيت وافقا', 'Ait Ouafqa', 'Public', 'PRIMAIRE', 'الابتدائي', 'Satellite', '16892K', 'password', NULL, NULL),
(31, '16893L', 'SS ALABDARI CENTRE IGUILIZ', 'م.م العبدري مركزية اكيليز', 'أيت وافقا', 'Ait Ouafqa', 'Public', 'PRIMAIRE', 'الابتدائي', 'Secteur Scolaire Centre', '73509P02', 'password', NULL, NULL),
(32, '16894M', 'SS ALABDARI UNITE MESTALAT', 'م.م العبدري فرعية مستلات', 'أيت وافقا', 'Ait Ouafqa', 'Public', 'PRIMAIRE', 'الابتدائي', 'Satellite', '73509P02', 'password', NULL, NULL),
(33, '16895N', 'SS BAKAR HOUCINE BEN HAISSON CENTRE ANAMER IGHECHA', 'م.م بكار حسين بن حيسون مركزية انامر اغشان', 'أيت وافقا', 'Ait Ouafqa', 'Public', 'PRIMAIRE', 'الابتدائي', 'Secteur Scolaire Centre', '73460P21', 'password', NULL, NULL),
(34, '16896P', 'SS ALMOKHTAR ASSOUSSI UNITE AGUERD OUFKIR', 'م.م المختار السوسي فرعية اكرض افقير', 'أيت وافقا', 'Ait Ouafqa', 'Public', 'PRIMAIRE', 'الابتدائي', 'Satellite', '', 'password', NULL, NULL),
(35, '16897R', 'SS ALABDARI UNITE TIZORZINE', 'م.م العبدري فرعية تيزورزين', 'أيت وافقا', 'Ait Ouafqa', 'Public', 'PRIMAIRE', 'الابتدائي', 'Satellite', '73509P02', 'password', NULL, NULL),
(36, '16898S', 'SS AL ADARISSA CENTRE DOUGADIR', 'م.م الادارسة مركزية الدوكادير', 'أيت وافقا', 'Ait Ouafqa', 'Public', 'PRIMAIRE', 'الابتدائي', 'Secteur Scolaire Centre', '73213P01', 'password', NULL, NULL),
(37, '16899T', 'SS AL ADARISSA UNITE TAYOUT', 'م.م الادارسة فرعية تيوت', 'أيت وافقا', 'Ait Ouafqa', 'Public', 'PRIMAIRE', 'الابتدائي', 'Satellite', '73213P01', 'password', NULL, NULL),
(38, '16900U', 'SS AL ADARISSA UNITE YOUSGAGHT', 'م.م الادارسة فرعية يوسكاغت', 'أيت وافقا', 'Ait Ouafqa', 'Public', 'PRIMAIRE', 'الابتدائي', 'Satellite', '', 'password', NULL, NULL),
...
(43, '16912G', 'EC ABDELMOUMEN CENTRE ANZI', 'م.ج عبد المومن مركز انزي', 'انزي', 'Anzi', 'Public', 'PRIMAIRE', 'الابتدائي', 'Ecole communale', '73105P01', 'password', NULL, NULL),
(44, '16913H', 'SS LAHOUCINE BEN BIROUK BEN AABLA CENTRE DAR LARBA', 'م.م الحسين بن بيروك بن عبلا مركزية دار الاربعاء', 'انزي', 'Anzi', 'Public', 'PRIMAIRE', 'الابتدائي', 'Secteur Scolaire Centre', '73460p26', 'password', NULL, NULL),
(45, '16916L', 'SS ACHNIT AHMED BEN BELAID UNITE IGROUMA', 'م.م اشنيط احمد بن بلعيد فرعية اكروما', 'انزي', 'Anzi', 'Public', 'PRIMAIRE', 'الابتدائي', 'Satellite', '', 'password', NULL, NULL),
(46, '16917M', 'SS ALHOUDA CENTRE IMI OUGNI', 'م.م الهدى مركزية امي اوكني', 'انزي', 'Anzi', 'Public', 'PRIMAIRE', 'الابتدائي', 'Secteur Scolaire Centre', '73215P01', 'password', NULL, NULL),
(47, '16918N', 'SS ALHOUDA UNITE TAMDGNOUT', 'م.م الهدى فرعية تمدكنوت', 'انزي', 'Anzi', 'Public', 'PRIMAIRE', 'الابتدائي', 'Satellite', '', 'password', NULL, NULL),
...
(51, '16927Y', 'SS ACHNIT AHMED BEN BELAID CENTRE INJJARN', 'م.م اشنيط احمد بن بلعيد مركزية انجارن', 'انزي', 'Anzi', 'Public', 'PRIMAIRE', 'الابتدائي', 'Secteur Scolaire Centre', '', 'password', NULL, NULL),
(52, '16928Z', 'SS LAHOUCINE BEN BIROUK BEN AABLA UNITE DIRANE', 'م.م الحسين بن بيروك بن عبلا فرعية الديران', 'انزي', 'Anzi', 'Public', 'PRIMAIRE', 'الابتدائي', 'Satellite', '928Z000', 'password', NULL, NULL),
...
(83, '16963M', 'SS ALBAYROUNI CENTRE IGHIR MOUSS', 'م.م البيروني مركزية اغير موس', 'أيت ايسافن', 'Ait Issafen', 'Public', 'PRIMAIRE', 'الابتدائي', 'Secteur Scolaire Centre', '73915P08', 'password', NULL, NULL),
(84, '16964N', 'SS MOHAMED SALEM CENTRE TIZGUI', 'م.م محمد سالم مركزية تيزكي', 'أيت ايسافن', 'Ait Issafen', 'Public', 'PRIMAIRE', 'الابتدائي', 'Secteur Scolaire Centre', '73460P23', 'password', NULL, NULL),
(85, '16965P', 'SS ALBAYROUNI UNITE ALKOUZ', 'م.م البيروني فرعية الكوز', 'أيت ايسافن', 'Ait Issafen', 'Public', 'PRIMAIRE', 'الابتدائي', 'Satellite', '965P000', 'password', NULL, NULL),
(86, '16967S', 'SS ALBAYROUNI UNITE IGOUJJIMNE', 'م.م البيروني فرعية اكجيمن', 'أيت ايسافن', 'Ait Issafen', 'Public', 'PRIMAIRE', 'الابتدائي', 'Satellite', '967S000', 'password', NULL, NULL),
(87, '16968T', 'SS MOHAMED SALEM UNITE TAOURIRT NALI NZKRI', 'م.م محمد سالم فرعية توريرت نعلي نزكري', 'أيت ايسافن', 'Ait Issafen', 'Public', 'PRIMAIRE', 'الابتدائي', 'Satellite', '73460P23', 'password', NULL, NULL),
(88, '16969U', 'SS ALBAYROUNI UNITE IGHALNE', 'م.م البيروني فرعية اغالن', 'أيت ايسافن', 'Ait Issafen', 'Public', 'PRIMAIRE', 'الابتدائي', 'Satellite', '', 'password', NULL, NULL),
...
(91, '16972X', 'SS ALBAYROUNI UNITE ROKENE', 'م.م البيروني فرعية الركن', 'أيت ايسافن', 'Ait Issafen', 'Public', 'PRIMAIRE', 'الابتدائي', 'Satellite', '972X000', 'password', NULL, NULL),
...
(228, '17246V', 'LYCEE QUALIFIANT MOHAMMED EL JAZOULI', 'الثانوية التاهيلية محمد الجزولي', 'انزي', 'Anzi', 'Public', 'SECONDAIRE QUALIFIANT', 'الثانوي التأهيلي', 'Lycée Enseignement Général', '73105S01', 'password', NULL, NULL),
...
(233, '17253C', 'LYCEE QUALIFIANT AL MASSIRA AL KHADRA', 'الثانوية التأهيلية المسيرة الخضراء', 'تزنيت (البلدية)', 'Tiznit (Mun.)', 'Public', 'BTS', 'شهادة التقني العالي', 'Lycée Enseignement Général & Technique', '73700S02', 'password', NULL, NULL),
...
(241, '18732K', 'SS ALBAYROUNI UNITE AIT DAOUD', 'م.م البيروني فرعية ايت داود', 'أيت ايسافن', 'Ait Issafen', 'Public', 'PRIMAIRE', 'الابتدائي', 'Satellite', '', 'password', NULL, NULL),
...
(260, '20721X', 'SS ALMOKHTAR ASSOUSSI UNITE AMALOU SRAG', 'م.م المختار السوسي فرعية املو اسرك', 'أيت وافقا', 'Ait Ouafqa', 'Public', 'PRIMAIRE', 'الابتدائي', 'Satellite', '', 'password', NULL, NULL),
...
(276, '21368A', 'SS SAADIYINE UNITE INLIOUA', 'م.م السعديين فرعية اينلوى', 'أفلا  اغير', 'Afella Ighir', 'Public', 'PRIMAIRE', 'الابتدائي', 'Satellite', '', 'password', NULL, NULL),
(277, '21369B', 'SS SAADIYINE UNITE TIMKIYTE', 'م.م السعديين فرعية تمقييت', 'أفلا  اغير', 'Afella Ighir', 'Public', 'PRIMAIRE', 'الابتدائي', 'Satellite', '', 'password', NULL, NULL),
(278, '21370C', 'SS LAHOUCINE BEN BIROUK BEN AABLA UNITE AGRD OUABD', 'م.م الحسين بن بيروك بن عبلا فرعية اكرض وعبدي', 'انزي', 'Anzi', 'Public', 'PRIMAIRE', 'الابتدائي', 'Satellite', '', 'password', NULL, NULL),
(279, '21372E', 'SS ACHNIT AHMED BEN BELAID UNITE TOUSLANE', 'م.م اشنيط احمد بن بلعيد فرعية توسلان', 'انزي', 'Anzi', 'Public', 'PRIMAIRE', 'الابتدائي', 'Satellite', '', 'password', NULL, NULL),
...
(282, '21377K', 'SS ALBAYROUNI UNITE AIT ELKASSEM', 'م.م البيروني فرعية ايت القاسم', 'أيت ايسافن', 'Ait Issafen', 'Public', 'PRIMAIRE', 'الابتدائي', 'Satellite', '', 'password', NULL, NULL),
(283, '21378L', 'SS ALBAYROUNI UNITE TIWISSENE', 'م.م البيروني فرعية توسين', 'أيت ايسافن', 'Ait Issafen', 'Public', 'PRIMAIRE', 'الابتدائي', 'Satellite', '', 'password', NULL, NULL),
...
(292, '22776F', 'SS ACHNIT AHMED BEN BELAID UNITE AIT LJIYAR', 'م.م اشنيط احمد بن بلعيد فرعية ايت الجيار', 'انزي', 'Anzi', 'Public', 'PRIMAIRE', 'الابتدائي', 'Satellite', '', 'password', NULL, NULL),
...
(296, '22781L', 'SS ALBAYROUNI UNITE AGARD IFARD', 'م.م البيروني فرعية اكرض افرض', 'أيت ايسافن', 'Ait Issafen', 'Public', 'PRIMAIRE', 'الابتدائي', 'Satellite', '781L000', 'password', NULL, NULL),
...
(303, '22802J', 'LYCEE QUALIFIANT IDRISS II', 'الثانوية التأهيلية ادريس الثاني', 'أيت وافقا', 'Ait Ouafqa', 'Public', 'SECONDAIRE QUALIFIANT', 'الثانوي التأهيلي', 'Lycée Enseignement Général', '73018s02', 'password', NULL, NULL),
(304, '22802J', 'LYCEE QUALIFIANT IDRISS II', 'الثانوية التأهيلية ادريس الثاني', 'أيت وافقا', 'Ait Ouafqa', 'Public', 'SECONDAIRE-COLLEGIAL', 'الثانوي الاعدادي', 'Lycée Enseignement Général', '73018s02', 'password', NULL, NULL),
...
(306, '22966M', 'SS ACHNIT AHMED BEN BELAID UNITE IMTCHANE', 'م.م اشنيط احمد بن بلعيد فرعية امتشان', 'انزي', 'Anzi', 'Public', 'PRIMAIRE', 'الابتدائي', 'Satellite', '', 'password', NULL, NULL),
...
(313, '23775S', 'LYCEE COLLEGIAL AFELLA IGHIR', 'الثانوية الإعدادية افلا اغير', 'أفلا  اغير', 'Afella Ighir', 'Public', 'SECONDAIRE-COLLEGIAL', 'الثانوي الاعدادي', 'Collège Enseignement Général', '73016s01', 'password', NULL, NULL),
...
(328, '26632X', 'EC AMMELNE', 'م.ج املن', 'املن', 'Ammelne', 'Public', 'PRIMAIRE', 'الابتدائي', 'Ecole communale', '', 'password', NULL, NULL),
