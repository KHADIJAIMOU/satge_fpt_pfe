...
if ($dateRange) {
    ...
    $absencesPrimaire = Rapport::select('absenceFirstPrimaire', 'absenceSecondPrimaire', 'absenceThirdPrimaire', 'absenceFourthPrimaire', 'absenceFifthPrimaire', 'absenceSixthPrimaire')
        ...
        $absencesCollege = Rapport::select('absenceFirstCollege', 'absenceSecondCollege', 'absenceThirdCollege')->where('typeClass', 'SECONDAIRE-COLLEGIAL')->whereDate('created_at',[$startDate, $endDate])
        ->get();
        $absenceCollegeTotal = 0;
        foreach ($absencesCollege as $absence) {
            $absenceCollegeTotal += $absence->absenceFirstCollege;
        ...
        $absencesLycee = Rapport::select('absenceFirstLycee', 'absenceSecondLycee', 'absenceThirdLycee')->where('typeClass', 'SECONDAIRE QUALIFIANT')->whereDate('created_at',[$startDate, $endDate])
        ->get();
                $absenceLyceeTotal = 0;
        foreach ($absencesLycee as $absence) {
            $absenceLyceeTotal += $absence->absenceFirstLycee;
        ...
        $absencesBTS = Rapport::select('absenceFirstComptabiliteGeneral', 'absenceSecondComptabiliteGeneral', 'absenceFirstManagementCommercial', 'absenceSecondManagementCommercial')->where('typeClass', 'BTS + SECONDAIRE QUALIFIANT')->whereDate('created_at',[$startDate, $endDate])
        ->get();
        $absenceBTSTotal = 0;
foreach ($absencesBTS as $absence) {
    $absenceBTSTotal += $absence->absenceFirstComptabiliteGeneral;
    ...
    $absenceslyceetwo= Rapport::select('absenceFirstLycee', 'absenceSecondLycee', 'absenceThirdLycee')->where('typeClass', 'BTS + SECONDAIRE QUALIFIANT')->whereDate('created_at',[$startDate, $endDate])
    ->get();
    $absencelyceetwoTotal = 0;
    foreach ($absenceslyceetwo as $absence) {
        $absencelyceetwoTotal += $absence->absenceFirstLycee;
    ...
    $absenceslyceeTREE= Rapport::select('absenceFirstLycee', 'absenceSecondLycee', 'absenceThirdLycee')->where('typeClass', 'SECONDAIRE QUALIFIANT + SECONDAIRE-COLLEGIAL')->whereDate('created_at',[$startDate, $endDate])
    ->get();
    $absencelyceeTREETotal = 0;
    foreach ($absenceslyceeTREE as $absence) {
        $absencelyceeTREETotal += $absence->absenceFirstLycee;
    ...
    $absencesCollegeOne= Rapport::select('absenceFirstCollege', 'absenceSecondCollege', 'absenceThirdCollege')->where('typeClass', 'SECONDAIRE QUALIFIANT + SECONDAIRE-COLLEGIAL')->whereDate('created_at',[$startDate, $endDate])
    ->get();
    $absencesCollegeOneTotal = 0;
    foreach ($absencesCollegeOne as $absence) {
        $absencesCollegeOneTotal += $absence->absenceFirstCollege;
    ...
    $lycee=$lycee1+$lycee2+$lycee3;
    $college=$college0+$college1;
    $insuffisantR= Rapport::select('RespectProgrammeNutritional')->where('RespectProgrammeNutritional', 0)->whereDate('created_at',[$startDate, $endDate])->count();
    $assezfaibleR= Rapport::select('RespectProgrammeNutritional')->where('RespectProgrammeNutritional', 1)->whereDate('created_at',[$startDate, $endDate])->count();
    $faibleR= Rapport::select('RespectProgrammeNutritional')->where('RespectProgrammeNutritional', 2)->whereDate('created_at',[$startDate, $endDate])->count();
    $passableR= Rapport::select('RespectProgrammeNutritional')->where('RespectProgrammeNutritional', 3)->whereDate('created_at',[$startDate, $endDate])->count();
    $assezbienR= Rapport::select('RespectProgrammeNutritional')->where('RespectProgrammeNutritional', 4)->whereDate('created_at',[$startDate, $endDate])->count();
    $bienR= Rapport::select('RespectProgrammeNutritional')->where('RespectProgrammeNutritional', 5)->whereDate('created_at',[$startDate, $endDate])->count();
/*quality*/
    $insuffisantquality= Rapport::select('quality')->where('quality', 0)->whereDate('created_at',[$startDate, $endDate])->count();
    $assezfaiblequality= Rapport::select('quality')->where('quality', 1)->whereDate('created_at',[$startDate, $endDate])->count();
    $faiblequality= Rapport::select('quality')->where('quality', 2)->whereDate('created_at',[$startDate, $endDate])->count();
    $passablequality= Rapport::select('quality')->where('quality', 3)->whereDate('created_at',[$startDate, $endDate])->count();
    $assezbienquality= Rapport::select('quality')->where('quality', 4)->whereDate('created_at',[$startDate, $endDate])->count();
    $bienquality= Rapport::select('quality')->where('quality', 5)->whereDate('created_at',[$startDate, $endDate])->count();
/*quantity*/
$insuffisantquantity= Rapport::select('quantity')->where('quantity', 0)->whereDate('created_at',[$startDate, $endDate])->count();
$assezfaiblequantity= Rapport::select('quantity')->where('quantity', 1)->whereDate('created_at',[$startDate, $endDate])->count();
$faiblequantity= Rapport::select('quantity')->where('quantity', 2)->whereDate('created_at',[$startDate, $endDate])->count();
$passablequantity= Rapport::select('quantity')->where('quantity', 3)->whereDate('created_at',[$startDate, $endDate])->count();
$assezbienquantity= Rapport::select('quantity')->where('quantity', 4)->whereDate('created_at',[$startDate, $endDate])->count();
