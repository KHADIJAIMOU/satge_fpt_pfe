    ...
    <center>
        ...
        <div class="tab1">
            ...
            <div id="lycee-div">
                ...
                <div class="card" style="width: auto;padding:20px;margin-top20px;">
                    ...
                    <p><input disabled required placeholder="" type="text" min="0" max="400" name="absenceFirstLycee"
                            id="absenceFirstLycee" value="{{ $data['rapport']->absenceFirstLycee }}"></p>

                    <label class=" col-form-label" style="text-align: left;">
                        Total élèves tronc commun
                    </label>
                    <p><input disabled required placeholder="" type="text" min="0" max="400" name="totalFirstLycee"
                            id="totalFirstLycee" value="{{ $data['rapport']->totalFirstLycee }}"></p>
                </div>
                <div class="card" style="width: auto;padding:20px;margin-top20px;">
                ...
                <div class="card" style="width: auto;padding:20px;margin-top20px;">
                    ...
                    <label class=" col-form-label" style="text-align: left;">
                        ...
                        <p><input disabled required placeholder="" type="text" min="0" max="400"
                                ...
                                value="{{ $data['rapport']->absenceSecondPrimaire }}">
                        </p>
        ...
        <div id="college-div">
            ...
            <div class=" card" style="width: auto;padding:20px;margin-top20px;">
                ...
                <label class=" col-form-label" style="text-align: left;">
                    Absence première année </label>
                <p><input disabled required placeholder="" type="text" min="0" max="400" oninput="this.className = ''"
                        name="absenceFirstComptabiliteGeneral" id="absenceFirstComptabiliteGeneral"
                        value="{{ $data['rapport']->absenceFirstComptabiliteGeneral }}"></p>

                <label class=" col-form-label" style="text-align: left;"> Total des étudiants de première année
                </label>
                <p><input disabled required placeholder="" type="text" min="0" max="400" oninput="this.className = ''"
                        name="totalFirstComptabiliteGeneral" id="totalFirstComptabiliteGeneral"
                        value="{{ $data['rapport']->totalFirstComptabiliteGeneral }}"></p>
            </div>
            <div class="card" style="width: auto;padding:20px;margin-top20px;">
                ...
                <label class=" col-form-label" style="text-align: left;">
                    absence de la deuxième année </label>
                <p><input disabled required placeholder="" type="text" min="0" max="400" oninput="this.className = ''"
                        name="absenceSecondComptabiliteGeneral" id="absenceSecondComptabiliteGeneral"
                        value="{{ $data['rapport']->absenceSecondComptabiliteGeneral }}"></p>
                ...
                <p><input disabled required placeholder="" type="text" min="0" max="400" oninput="this.className = ''"
                        name="totalSecondComptabiliteGeneral" id="totalSecondComptabiliteGeneral"
                        value="{{ $data['rapport']->totalSecondComptabiliteGeneral }}"></p>
            </div>
        ...
        <div id="college-div">
            ...
            <div class=" card" style="width: auto;padding:20px;margin-top20px;">
                ...
                <label class=" col-form-label" style="text-align: left;">
                    Absence première année </label>
                <p><input disabled required placeholder="" type="text" min="0" max="400" oninput="this.className = ''"
                        name="absenceFirstManagementCommercial" id="absenceFirstManagementCommercial"
                        value="{{ $data['rapport']->absenceFirstManagementCommercial }}"></p>

                <label class=" col-form-label" style="text-align: left;">
                    Le nombre total d'étudiants de première année </label>
                <p><input disabled required placeholder="" type="text" min="0" max="400" oninput="this.className = ''"
                        name="totalFirstManagementCommercial" id="totalFirstManagementCommercial"
                        value="{{ $data['rapport']->totalFirstManagementCommercial }}"></p>
            </div>
            <div class="card" style="width: auto;padding:20px;margin-top20px;">
                ...
                <label class=" col-form-label" style="text-align: left;">
                    absence de la deuxième année </label>
                <p><input disabled required placeholder="" type="text" min="0" max="400" oninput="this.className = ''"
                        name="absenceSecondManagementCommercial" id="absenceSecondManagementCommercial"
                        value="{{ $data['rapport']->absenceSecondManagementCommercial }}"></p>
                ...
                <p><input disabled required placeholder="" type="text" min="0" max="400" oninput="this.className = ''"
                        name="totalSecondManagementCommercial" id="totalSecondManagementCommercial"
                        value="{{ $data['rapport']->totalSecondManagementCommercial }}"></p>
            </div>
        ...
        <div id="college-div">
            ...
            <div class=" card" style="width: auto;padding:20px;margin-top20px;">
                ...
                <label class=" col-form-label" style="text-align: left;">
                    Absence de la première année collegial </label>
                <p><input disabled required placeholder="" type="text" min="0" max="400" oninput="this.className = ''"
                        name="absenceFirstCollege" id="absenceFirstCollege"
                        value="{{ $data['rapport']->absenceFirstCollege }}"></p>
                ...
                <p><input disabled required placeholder="" type="text" min="0" max="400" oninput="this.className = ''"
                        name="totalFirstCollege" id="totalFirstCollege"
                        value="{{ $data['rapport']->totalFirstCollege }}"></p>
            </div>
            <div class="card" style="width: auto;padding:20px;margin-top20px;">
                ...
                <label class=" col-form-label" style="text-align: left;">
                    Absence de la deuxième année collegial </label>
                <p><input disabled required placeholder="" type="text" min="0" max="400" oninput="this.className = ''"
                        name="absenceSecondCollege" id="absenceSecondCollege"
                        value="{{ $data['rapport']->absenceSecondCollege }}"></p>
                ...
                <p><input disabled required placeholder="" type="text" min="0" max="400" oninput="this.className = ''"
                        name="totalSecondCollege" id="totalSecondCollege"
                        value="{{ $data['rapport']->totalSecondCollege }}"></p>
            </div>
            <div class="card" style="width: auto;padding:20px;margin-top20px;">
                ...
                <label class=" col-form-label" style="text-align: left;">
                    Absence de la troisième année de collegial </label>
                <p><input disabled required placeholder="" type="text" min="0" max="400" oninput="this.className = ''"
                        name="absenceThirdCollege" id="absenceThirdCollege"
                        value="{{ $data['rapport']->absenceThirdCollege }}"></p>
                ...
                <label class=" col-form-label" style="text-align: left;">
                    Le nombre total d'élèves de troisième année collegial </label>
                <p><input disabled required placeholder="" type="text" min="0" max="400" oninput="this.className = ''"
                        name="totalThirdCollege" id="totalThirdCollege"
                        value="{{ $data['rapport']->totalThirdCollege }}"></p>
            </div>
        </div>
        <div id="errorMessage" style="display: none; color: red;">Value must be between 0 and 400</div>
        ...
        <div id="lycee-div">
            ...
            <div class="card" style="width: auto;padding:20px;margin-top20px;">
                ...
                <label id="myInput" class=" col-form-label" style="text-align: left;">
                    Absence du premier bac </label>
                <p><input disabled required placeholder="" type="text" min="0" max="400" oninput="this.className = ''"
                        name="absenceSecondLycee" id="absenceSecondLycee"
                        value="{{ $data['rapport']->absenceSecondLycee }}"></p>
                ...
                <p><input disabled required placeholder="" type="text" min="0" max="400" oninput="this.className = ''"
                        name="totalSecondLycee" id="totalSecondLycee" value="{{ $data['rapport']->totalSecondLycee }}">
                </p>
            </div>
            <div class="card" style="width: auto;padding:20px;margin-top20px;">
                ...
                <label class=" col-form-label" style="text-align: left;">
                    Absence du deuxième baccalauréat </label>
                <p><input disabled required placeholder="" type="text" min="0" max="400" oninput="this.className = ''"
                        name="absenceThirdLycee" id="absenceThirdLycee"
                        value="{{ $data['rapport']->absenceThirdLycee }}"></p>
                ...
                <p><input disabled required placeholder="" type="text" min="0" max="400" oninput="this.className = ''"
                        name="totalThirdLycee" id="totalThirdLycee" value="{{ $data['rapport']->totalThirdLycee }}"></p>
            </div>
        </div>
        @endif
        </div>
            ...
            <div id="lycee-div">
                ...
                <div id="lycee-div">
                    ...
                    <div class="card" style="width: auto;padding:20px;margin-top20px;">
                        ...
                        <p><input disabled required placeholder="" type="text" oninput="this.className = ''" min="0"
                                max="400" name="presentRevision" id="presentRevision"
        ...
        <div class="tab1">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td><input disabled type="checkbox" name="renionEffectuerConseilAdministratif"
                                        onclick="checkRien()" value="oui" @if
                                        ($data['rapport']->renionEffectuerConseilAdministratif == 'oui') checked @endif>
                                </td>
                                <td><input disabled type="checkbox" name="renionEffectuerConseilsDepartementaux"
                                        onclick="checkRien()" value="oui" @if
                                        ($data['rapport']->renionEffectuerConseilsDepartementaux == 'oui') checked
                                    @endif></td>
                                <td><input disabled type="checkbox" name="renionEffectuerConseilsPedagogiqueTa3limi"
                                        onclick="checkRien()" value="oui" @if
                                        ($data['rapport']->renionEffectuerConseilsPedagogiqueTa3limi == 'oui') checked
                                    @endif></td>
                                <td><input disabled type="checkbox" name="renionEffectuerConseilsPedagogiqueTrbaoui"
                                        onclick="checkRien()" value="oui" @if
                                        ($data['rapport']->renionEffectuerConseilsPedagogiqueTrbaoui == 'oui') checked
                                    @endif></td>
                                <td><input disabled type="checkbox" name="renionEffectuerConseilDeGestion" value="oui"
                                        onclick="checkRien()" @if ($data['rapport']->renionEffectuerConseilDeGestion ==
                                    'oui') checked @endif>
                                </td>
                                <td><input disabled type="checkbox"
                                        name="renionEffectuerRenionAssociationSoutienScolaire" value="oui"
                                        onclick="checkRien()" @if
                                        ($data['rapport']->renionEffectuerRenionAssociationSoutienScolaire == 'oui')
                                    checked @endif></td>
                                <td><input disabled type="checkbox" name="renionEffectuerAutreRenion" value="oui"
                                        onclick="checkRien()" @if ($data['rapport']->renionEffectuerAutreRenion ==
                                    'oui') checked @endif>
                                </td>
                                <td><input disabled type="checkbox" name="renionEffectuerRien" value="oui"
                                        onclick="uncheckOthers()" @if ($data['rapport']->renionEffectuerRien == 'oui')
                                    checked @endif>
                                </td>
                            </tr>
                        </tbody>
            ...
            <div id="lycee-div">
                ...
                <div class="card" style="width: auto;padding:20px;margin-bottom:10px;padding:10px">
                    ...
                    <input disabled type="checkbox" name="activiteEffectuerIntégrée" value="oui"
                        onclick="checkRienSecond()" @if ($data['rapport']->activiteEffectuerIntégrée == 'oui') checked
                    @endif>
                    <label>Activités intégrées</label>
                    <input disabled type="checkbox" name="activiteEffectuerParallel" value="oui"
                        onclick="checkRienSecond()" @if ($data['rapport']->activiteEffectuerParallel == 'oui') checked
                    @endif>
                    <label>Activités parallèles</label>
                    <input disabled type="checkbox" name="activiteEffectuerRien" value="oui"
                        onclick="uncheckOthersSecond()" @if ($data['rapport']->activiteEffectuerRien == 'oui') checked
                    @endif>
                    <label>aucun</label>
                </div>
            </div>
            ...
            <div id="lycese-div">
                <br>
                <div class="card" style="width: auto;padding:20px;margin-bottom:10px;padding:10px">
                    <textarea disabled required id="rapportVisit" name="rapportVisit" id="rapportVisit"
                        style="width: 100%">{{ $data['rapport']->rapportVisit }}</textarea>
                </div>
            </div>
            <center>
                <div class="card-header" style="background-color:#F6DEC0;border-radius: 10px;">
            ...
            <div id="lycee-div">
                <br>
                <div class="card" style="width: auto;padding:20px;margin-bottom:10px;padding:10px">
                    <textarea disabled required id="rapportAccidentScolaire" name="rapportAccidentScolaire"
                        id="rapportAccidentScolaire"
            ...
            <div id="lycee-div">
                <br>
                <div class="card" style="width: auto;padding:20px;margin-bottom:10px;padding:10px">
                    <textarea disabled required id="different " oninput="this.className = ''" name="different"
                        name="different" style="width: 100%">{{ $data['rapport']->different }}</textarea>
                </div>
            </div>
            <center>
                <div class="card-header" style="background-color:#F6DEC0;border-radius: 10px;">
            ...
            <div id="lycee-div">
                ...
                <div class="card" style="width: auto;padding:20px;margin-bottom:10px;padding:10px">
                    ...
                    <input disabled type="radio" name="classInterieur" value="oui" onclick="showDiv(this)" @if
                        ($data['rapport']->classInterieur == 'oui') checked @endif> <label>oui</label>
                    <input disabled type="radio" name="classInterieur" value="non" onclick="showDiv(this)" @if
                        ($data['rapport']->classInterieur == 'non') checked @endif><label>non</label>

                </div>
            </div>
            <div id="div1" @if ($data['rapport']->classInterieur == 'oui') style="display:block" @else
                ...
                <div id="lycee-div">
                    ...
                    <div class="card" style="width: auto;padding:20px;margin-top20px;">
                        ...
                        <p><input disabled required placeholder="" type="text" oninput="this.className = ''" min="0"
                                max="400" name="inscritPetitDejeuner" id="inscritPetitDejeuner"
                        ...
                        <p><input disabled placeholder="" type="text" min="0" max="400" oninput="this.className = ''"
                                name="inscritDinner" id="inscritDinner" value="{{ $data['rapport']->inscritDinner }}">
                        </p>
                        <label class=" col-form-label" style="text-align: left;">
                ...
                <div id="lycee-div" style="text-align: left">
                    ...
                    <label class="col-form-label" style="text-align: left;">Programme Nutritional:
                        ...
                        <span><img class="mx-auto d-block" style="width:15%;"
            ...
            <div id="div2" @if ($data['rapport']->classInterieur == 'non') style="display:block" @else
                style="display:none" @endif>
            </div>
