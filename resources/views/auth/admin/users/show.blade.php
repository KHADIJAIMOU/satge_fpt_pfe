...
@section('title', "Afficher  L'utilisateur")
@section('content')
    ...
    <i class="fa-solid fa-arrow-left"></i> précédent
        ...
        <div class="card-body">
            <div class="form-group">
                ...
                <input  disabled type="text" class="form-control" name="CD_ETAB" id="CD_ETAB" placeholder="Enter CD_ETAB"
                    value="{{  $User->CD_ETAB  }}">
            </div>
            <div class="form-group">
                <label for="email">NOM_ETABL</label>
                <input  disabled type="text" class="form-control" name="NOM_ETABL" id="NOM_ETABL" placeholder="Enter NOM_ETABL"
                    value="{{  $User->NOM_ETABL  }}">
            </div>
            <div class="form-group">
                <label for="email">NOM_ETABA</label>
                <input  disabled type="text" class="form-control" name="NOM_ETABA" id="NOM_ETABA" placeholder="Enter NOM_ETABA"
                    value="{{  $User->NOM_ETABA  }}">
            </div>
            <div class="form-group">
                <label for="la_com">la_com</label>

                <select  disabled name="la_com" class="form-control"   >
            ...
            <div class="form-group">
                ...
                <select disabled name="ll_com" class="form-control"   >
            ...
            <div class="form-group">
                ...
                <select disabled name="typeEtab" class="form-control"   >
            ...
            <div class="form-group">
                ...
                <select disabled name="LL_CYCLE" class="form-control"   >
            ...
            <div class="form-group">
                ...
                <select disabled  name="LA_CYCLE" class="form-control"   >
            ...
            <div class="form-group">
                ...
                <select disabled  name="NetabFr" class="form-control"   >
            ...
            <div class="form-group">
                ...
                <input disabled type="text" class="form-control" name="CD_GIPE" id="CD_GIPE" placeholder="Enter CD_GIPE"
                    value="{{  $User->CD_GIPE  }}">
            </div>
            <div class="form-group">
                <label for="password">password</label>
                <input disabled type="password" class="form-control" name="password" id="CD_ETAB" placeholder="Enter password"
                    value="{{  $User->password  }}">
            </div>
