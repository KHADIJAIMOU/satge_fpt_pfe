                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="form-group row">
                                <label for="NOM_ETABL" class="col-md-4 col-form-label text-md-right">{{ __('NOM_ETABL') }}</label>
                            ...
                            <div class="form-group row">
                                <label for='CD_ETAB' class="col-md-4 col-form-label text-md-right">{{ __('E-Mail Address') }}</label>
