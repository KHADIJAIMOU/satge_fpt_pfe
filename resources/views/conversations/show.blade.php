                     ...
                     <div class="card-header">{{ $user->name }}
                         <div class="card-body conversations">
                          ...
                          <div class="direct-chat-msg {{ $message->from->id !== $user->id ? 'right' : 'left' }}">
                            ...
                            <!-- /.direct-chat-infos -->
<img class="direct-chat-img" src="{{ asset('storage/' . ($message->from->id !== $user->id ? $message->from->image : $user->image)) }}" alt="message user image">
                            <!-- /.direct-chat-img -->
                            <div class="direct-chat-text {{ $message->from->id !== $user->id ? 'bg-info' : 'bg-warning' }}">
                         ...
                         <div class="card">
                             <div class="card-header">{{ $user->name }}
                                 <div class="card-body conversations">
                                  ...
                                  <div class="direct-chat-msg {{ $message->from->id !== $user->id ? 'right' : 'left' }}">
                                    <div class="direct-chat-infos clearfix">
                                      <span class="direct-chat-name {{ $message->from->id !== $user->id ? 'float-right' : 'float-left' }}">{{ $message->from->id !== $user->id ? 'Moi' : $message->from->NOM_ETABL }}</span>
                                      <br>
                                      <span class="direct-chat-timestamp  {{ $message->from->id !== $user->id ? 'float-right' : 'float-left' }}">{{ $message->created_at}}</span>
                                    </div>
